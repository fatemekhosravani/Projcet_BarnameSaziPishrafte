...
namespace kimi {
    ...
    public partial class playerDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Family, int Age, string Team, int Number, string Pose, string phone, string email) {
...
namespace kimi.playerDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([Id], [Name], [Family], [Age], [Team], [Number], [Pose], [phone], [email]) VALUES (@Id, @Name, @Family, @Age, @Team, @Number, @Pose, @phone, @email);
SELECT Id, Name, Family, Age, Team, Number, Pose, phone, email FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Family] = @Family, [Age] = @Age, [Team] = @Team, [Number] = @Number, [Pose] = @Pose, [phone] = @phone, [email] = @email WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Family] = @Original_Family) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Team = 1 AND [Team] IS NULL) OR ([Team] = @Original_Team)) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)) AND ((@IsNull_Pose = 1 AND [Pose] IS NULL) OR ([Pose] = @Original_Pose)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT Id, Name, Family, Age, Team, Number, Pose, phone, email FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Family, Age, Team, Number, Pose, phone, email FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Family, global::System.Nullable<int> Original_Age, string Original_Team, global::System.Nullable<int> Original_Number, string Original_Pose, string Original_phone, string Original_email) {
        ...
        public virtual int Insert(int Id, string Name, string Family, global::System.Nullable<int> Age, string Team, global::System.Nullable<int> Number, string Pose, string phone, string email) {
        ...
        public virtual int Update(
            ...
            if ((Original_Pose == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_Pose));
            }
            if ((Original_phone == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_phone, 
                    string Original_email) {
            return this.Update(Original_Id, Name, Family, Age, Team, Number, Pose, phone, email, Original_Id, Original_Name, Original_Family, Original_Age, Original_Team, Original_Number, Original_Pose, Original_phone, Original_email);
        }
    }
